@extends('layouts.app')
@section('content')
@include('components.front.page-header', ['kicker' => __('messages.nav_contact'), 'title' => __('messages.nav_contact'), 'subtitle' => __('messages.footer_tagline')])
