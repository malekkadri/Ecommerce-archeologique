...
<section class="max-w-5xl mx-auto px-4 py-10 space-y-6" data-page="about">
    <div class="fo-callout">
        ...
        <p class="mt-2 text-charcoal/80 leading-relaxed">A trusted ecosystem should help people move from inspiration to confident action: publish useful context, teach clear methods, coach deliberate practice, and support implementation with reliable products.</p>
    </div>
