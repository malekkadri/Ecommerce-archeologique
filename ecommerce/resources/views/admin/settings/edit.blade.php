...
<section class="space-y-6">
    ...
    <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data" class="admin-card p-6 grid lg:grid-cols-2 gap-5">
        ...
        <div class="lg:col-span-2 border-b border-slate-100 pb-2">
        ...
        <div class="lg:col-span-2 mt-2 border-b border-slate-100 pb-2"><h2 class="font-semibold text-lg">Branding</h2></div>
        <div>
        ...
        <div class="lg:col-span-2 mt-2 border-b border-slate-100 pb-2"><h2 class="font-semibold text-lg">SEO</h2></div>
        ...
        <div class="lg:col-span-2 mt-2 border-b border-slate-100 pb-2"><h2 class="font-semibold text-lg">Contact</h2></div>
        ...
        <div class="lg:col-span-2 mt-2 border-b border-slate-100 pb-2"><h2 class="font-semibold text-lg">Social</h2></div>
        ...
        <div class="lg:col-span-2 mt-2 border-b border-slate-100 pb-2"><h2 class="font-semibold text-lg">Homepage</h2></div>
        ...
        <div class="lg:col-span-2 mt-2 border-b border-slate-100 pb-2"><h2 class="font-semibold text-lg">Footer</h2></div>
        ...
        <div class="lg:col-span-2 flex gap-3 pt-4 border-t border-slate-100 mt-2">
