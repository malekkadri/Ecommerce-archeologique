...
@section('content')
<section class="max-w-5xl mx-auto px-4 py-12" data-page="content-detail">
    <div class="fo-panel p-7 md:p-8 fo-header-editorial">
        ...
        <article class="fo-readable max-w-none mt-8 text-charcoal/90">{!! nl2br(e($content->body)) !!}</article>
    </div>
</section>
@endsection
